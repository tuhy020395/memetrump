( () => {
                ...
                i(Array.from(t).map((function(t) {
                    ...
                    let o = e.split("|")
                      ...
                      , s = Array.from(t).filter((function(t) {
                        ...
                        if (String(e) === a.root && String(o) === a.margin && String(s) === a.threshold)
                            return t
                    }
                    ))
    ...
    new class {
        ...
        init() {
            ...
            this.mediaQueries = this.оbjects.map(( ({breakpoint: t}) => `(${this.type}-width: ${t / 16}em),${t}`)).filter(( (t, e, o) => o.indexOf(t) === e)),
    ...
    axios.get("https://dexscreener.com/solana/awf3vy8r6bfx8dru5xkubxnufndte7rihnt9ftwz79uu").then((t => {
        const e = t.data.pairs[0].fdv;
        document.getElementById("capValue").textContent = `${Math.floor(e / 1e3)}`
    }
    )).catch((t => {
